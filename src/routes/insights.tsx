    ...
    <AppShell>
      ...
      <section className="px-5 pb-3">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-sm font-semibold">{tr("fc.open")}</span>
            <span className="block truncate text-xs text-muted-foreground">{tr("fc.openDesc")}</span>
          </span>
          <ArrowRight className="h-4 w-4 shrink-0 text-muted-foreground" />
        </Link>
      </section>
      ...
      <section className="px-5 pb-3">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-sm font-semibold">{tr("wi.open")}</span>
            <span className="block truncate text-xs text-muted-foreground">{tr("wi.openDesc")}</span>
          </span>
          <ArrowRight className="h-4 w-4 shrink-0 text-muted-foreground" />
        </Link>
      </section>
      ...
      <section className="px-5 pb-3">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-sm font-semibold">{tr("dh.open")}</span>
            <span className="block truncate text-xs text-muted-foreground">{tr("dh.openDesc")}</span>
          </span>
          <ArrowRight className="h-4 w-4 shrink-0 text-muted-foreground" />
        </Link>
      </section>
      ...
      <section className="px-5 pb-3">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-sm font-semibold">{tr("ef.open")}</span>
            <span className="block truncate text-xs text-muted-foreground">{tr("ef.openDesc")}</span>
          </span>
          <ArrowRight className="h-4 w-4 shrink-0 text-muted-foreground" />
        </Link>
      </section>
